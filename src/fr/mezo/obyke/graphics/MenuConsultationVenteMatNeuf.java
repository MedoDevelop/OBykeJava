...
public class MenuConsultationVenteMatNeuf extends MenuConsultationDroit {
	...
	public MenuConsultationVenteMatNeuf(int lineLeft,int lineRight) throws SQLException {
		/**
		 * 
		 */
			super(7);
		...
		public void setTable() throws SQLException {
			...
			ArrayList<LigneCommande> arrMat = new ArrayList<LigneCommande>(BD.LigneCommandeData.GetAllNeuf());
					...
					if (e.getClickCount() == 1) {
					      ...
					      int row = this.table.getSelectedRow();
					       //On récupère l'id de l'objet sélectionné, il sera utilisé pour la modification en base de donées
					       	...
					       	try {
								mat.setText(BD.MaterielData.MaterielNeufData.Get(idMat).toString());
	...
	public void update() throws SQLException {
		...
		//Récupération des données de la base que l'on ajoute dans une liste
		ArrayList<LigneCommande> arr = new ArrayList<LigneCommande>(BD.LigneCommandeData.GetAllNeuf());
