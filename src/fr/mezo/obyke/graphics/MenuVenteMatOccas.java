...
public class MenuVenteMatOccas extends MenuConsultationDroit {
	...
	public MenuVenteMatOccas(int lineLeft,int lineRight) throws SQLException {
		super(7);
		this.prixMat = 0;
		this.prixGarantie = 0;
	...
	public void setTable() throws SQLException {
		...
		ArrayList<MaterielOccasion> arrMat = new ArrayList<MaterielOccasion>(BD.MaterielData.MaterielOccasionData.GetAllAVentre());
				...
				if (e.getClickCount() == 1) {
				      ...
				      int row = this.table.getSelectedRow();
				       //On récupère l'id de l'objet sélectionné, il sera utilisé pour la modification en base de donées
				       	...
				       	setId(newId);
				       	try {
							prixMat = BD.MaterielData.MaterielOccasionData.Get(newId).getPrixVente();
						} catch (SQLException e1) {
							// TODO Auto-generated catch block
							prixMat = 0;
							e1.printStackTrace();
	...
	public void update() throws SQLException {
		...
		//Récupération des données de la base que l'on ajoute dans une liste
		ArrayList<MaterielOccasion> arr = new ArrayList<MaterielOccasion>(BD.MaterielData.MaterielOccasionData.GetAllAVentre());
